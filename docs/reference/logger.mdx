...
Redaction runs before entries reach the configured driver or `onWrite`. Panther redacts common credential fields such as tokens, secrets, passwords, authorization headers, API keys, and credential values by default.
