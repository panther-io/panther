---
title: "Onboarding"
description: "Core concepts and architecture of Panther."
---

Panther is a centralized MCP proxy. It sits in front of your MCP servers and exposes a single HTTP endpoint with policy, routing, and observability built in.
...
Panther prefixes tool names to avoid collisions. Each tool becomes `server__tool`, and the displayed title includes the server `displayName`.
